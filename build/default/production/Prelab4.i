...
push: ; esta la indicación push
    ...
    movwf STATUS_TEMP
isr:
    btfsc ((INTCON) and 07Fh), 2 ; Interrupcion del tmr0
    call int_t0

    btfsc ((INTCON) and 07Fh), 0 ; Interrupcion del on-change
    call int_iocb
...
int_iocb: ;on-change
    ...
    bcf ((INTCON) and 07Fh), 0 ; se reinicia la bandera
    return
...
int_t0:
    ...
    btfss ((STATUS) and 07Fh), 2 ; si esta el bit 2 en cero
    goto RETURN_T0
    clrf CONT
    incf PORT1
...
config_tmr0:
    banksel TRISD
    bcf ((OPTION_REG) and 07Fh), 5 ; reloj interno - tmr0 como contador
...
config_reloj:
    ...
    bsf ((OSCCON) and 07Fh), 6 ; OSCCON,6
    bsf ((OSCCON) and 07Fh), 5 ; OSCCON,5
    bcf ((OSCCON) and 07Fh), 4 ; OSCCON,4
